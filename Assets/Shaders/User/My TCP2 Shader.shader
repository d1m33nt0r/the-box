...
Shader "Toony Colors Pro 2/User/My TCP2 Shader"
{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha noforwardadd addshadow nolightmap nofog nolppv
		#pragma target 2.5
